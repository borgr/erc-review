...
this repository execute it — [`.claude/skills/erc-review/SKILL.md`](.claude/skills/erc-review/SKILL.md),
a Claude Code skill that drives the judgment stages, and
...
what the `erc-review` skill (`.claude/skills/erc-review/SKILL.md`) executes, and a human
